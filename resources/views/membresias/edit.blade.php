<x-app-layout title="Editar Membresía - Mama2s Gym">
    <div class="py-12 bg-gray-50">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900">Editar Membresía</h1>
                <p class="text-gray-600 mt-2">Modifica la información del plan de membresía</p>
            </div>

            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('membresias.update', $membresia) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('acceso_clases_grupales', $membresia->acceso_clases_grupales) ? 'checked' : '' }}
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('acceso_zona_vip', $membresia->acceso_zona_vip) ? 'checked' : '' }}
                                       class="rounded border-gray-300 text-orange-500 focus:ring-orange-500">
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('plan_nutricional', $membresia->plan_nutricional) ? 'checked' : '' }}
                                       class="rounded border-gray-300 text-orange-500 focus:ring-orange-500">
